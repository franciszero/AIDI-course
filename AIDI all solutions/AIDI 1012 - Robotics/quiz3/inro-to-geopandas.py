...
landuse = gpd.read_file('C:\geopandas\TO_landuse.shp')
landuse.plot(cmap = 'jet', column = 'CATEGORY', figsize = (10,10))
# landuse.to_file('C:/Ali/geopandas/landuse-1.shp')

#IncidentsShortVaughan = gpd.read_file('C:/Ali/geopandas/IncidentsShort-Vaughan.shp')
#IncidentsShortVaughan.plot(figsize = (10,10))

# GTA_Pop_Sex = gpd.read_file('C:/Ali/geopandas/GTA_Pop_Sex.shp')
# GTA_Pop_Sex.plot(cmap = 'jet', column = 'POP2006', figsize = (10,10))

# GTA_Income_Pipeline = gpd.read_file('C:/Ali/geopandas/GTA_Income_Pipeline.shp')
# GTA_Income_Pipeline.plot(cmap = 'jet', figsize = (10,10))

# GTA_PipeLine = gpd.read_file('C:/Ali/geopandas/GTA_PipeLine.shp')
# GTA_PipeLine.plot(cmap = 'jet', figsize = (10,10))

# Display GTA and Toronto
# GTA_Pop_Sex = gpd.read_file('C:/Ali/geopandas/GTA_Pop_Sex.shp')
# GTA_Pop_Sex.plot(cmap = 'jet', column = 'POP2006')
# Toronto_border = gpd.read_file('C:/Ali/geopandas/Toronto_border.shp')
...
# GTA_Pop_Sex_in_Toronto.to_file('C:/Ali/geopandas/Intersected_GTA_Pop_Sex.shp')
...
# make a query
# Canada3 = gpd.read_file('C:\Ali\geopandas\CAN_adm3.shp')
...
# Save the geodataframe to a .shp (Shapfile)
# RichmondHill.to_file('C:/Ali/geopandas/New_RichmondHill.shp')
...
# selectedIncidents.to_file('C:/Ali/geopandas/Selected Incidents Vaughan.shp')

# buffer and dissolve polygons
# SelectedIncidentsVaughan = gpd.read_file('C:\Ali\geopandas\Selected Incidents Vaughan.shp')
# SelectedIncidentsVaughan.plot(color = 'red', column = 'alm_date', figsize = (5,5))
# bufSelectedIV = SelectedIncidentsVaughan.buffer(1000)
# bufSelectedIV.to_file('C:\Ali\geopandas\Buffer 1000.shp')
...
#l7_composite = r"C:\geopandas\Toronto_Landsat\l7_composite.img"
...
# read raster data
#l7_composite = r"C:\Ali\geopandas\Toronto_Landsat\l7_composite.img"
#raster = rio.open(l7_composite)
...
# Read DEM file
# dem1bsq1 = r"C:\Ali\geopandas\Toronto_Landsat\dem1bsq1.tif"
...
# loadedData = np.loadtxt('C:\Ali\geopandas\demtxt.txt')
...
# dtm = "C:\Ali\geopandas\Toronto_Landsat\dem1bsq1.tif"
